...
/**
 * The physics debug overlay's look, drawn by {@code ModelPhysicsDebug}. The whole
 * chain is shown by default; the wind element's size is the arrow length per unit
 * of force.
 */
