...
/**
 * One element of a model debug overlay (chain lines, a marker): whether it is
 * drawn, its colour, its size — relative to the chain's segment length, so it
 * fits any rig — and, for markers, its shape. Built through
 * {@link ValueModelDebug}'s {@code line}/{@code element} helpers, never directly.
 */
